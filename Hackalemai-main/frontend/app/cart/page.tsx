...
export default function CartPage() {
  ...
  useEffect(() => { const sessionId = getSessionId(); void fetch(`${API}/api/cart?session_id=${encodeURIComponent(sessionId)}`).then((r) => r.json()).then(setCart).catch(() => undefined).finally(() => setLoading(false)); }, []);
